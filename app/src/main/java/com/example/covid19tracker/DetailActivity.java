...
public class DetailActivity extends AppCompatActivity {
    ...
    TextView tvCountry, tvCases, tvRecovered, tvCritical, tvActive, tvTodayCases, tvTotalDeaths, tvTodayDeaths, tvTotalTests;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Corona Detail of " + AffectedCountries.countryModelList.get(positionCountry).getCountry());
...
//
        ...
        tvTotalTests.setText(AffectedCountries.countryModelList.get(positionCountry).getTests());
